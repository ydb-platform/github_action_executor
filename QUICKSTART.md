...
2. **После изменения прав:**
   - Перейдите на страницу установки GitHub App в вашем репозитории/организации
   - GitHub может предложить обновить установку, чтобы применить новые права
   - Если не предложено автоматически, нажмите **Configure** → **Update installation**
...
**Примечание:** После изменения прав GitHub App, все установки приложения нужно обновить вручную.
